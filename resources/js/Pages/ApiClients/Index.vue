...
<template>
    ...
    <Layout>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-left text-gray-500">
                        <tr>
                            ...
                            <th class="px-4 py-3">Allowed Domains</th>
                    ...
                    <tbody>
                        <tr v-for="client in clients" :key="client.id" class="border-t border-gray-100">
        ...
        <div v-if="showCreateModal" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl p-6 w-full max-w-md">
                ...
                <div class="flex justify-end gap-2 mt-6">
                    <button @click="showCreateModal = false" class="px-4 py-2 text-sm text-gray-600">
                        Cancel
                    </button>
                    <button
                        @click="submitCreate"
        ...
        <div v-if="showKeyModal && plainKey" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl p-6 w-full max-w-md">
                ...
                <div class="flex items-center gap-2 bg-gray-50 border rounded-lg px-3 py-2">
                    ...
                    <button @click="copyKey" class="text-gray-500 hover:text-gray-900">
        ...
        <!-- Edit Modal -->
        <div v-if="editingClient" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl p-6 w-full max-w-md">
                ...
                <div class="flex justify-end gap-2 mt-6">
                    <button @click="editingClient = null" class="px-4 py-2 text-sm text-gray-600">
                        Cancel
                    </button>
                    <button
                        @click="submitEdit"
