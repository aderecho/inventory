...
// ------------------------------------------------------------------
// SELECTION STATE — single source of truth mapping id -> item, so
// selections survive pagination without being rebuilt from the
// current page's data.
// ------------------------------------------------------------------
                ...
                <div class="flex flex-col sm:flex-row gap-2 mt-2">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent class="w-48 rounded-lg shadow-lg border border-[#f5c6d8]">
                            ...
                            >
                                <UserPlus class="w-4 h-4 mr-2 text-[#850038]" />
                                Assign
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                                ...
                                class="text-xs font-medium hover:bg-[#fff0f6] hover:text-[#850038] cursor-pointer"
                            >
                                <QrCode class="w-4 h-4 mr-2 text-[#850038]" />
                                Sticker
                            </DropdownMenuItem>
