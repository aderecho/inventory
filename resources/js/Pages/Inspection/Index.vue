...
<template>
    ...
    <Layout>
        ...
        <div class="w-full h-full">
            <div class="mt-5 bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <!-- HEADER -->
                <div class="bg-gradient-to-r from-[#003d2c] via-[#005740] to-[#00795a] px-6 py-5">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                        <div>
                            <h2 class="text-xl font-bold text-white">Asset Inspection</h2>
                            <p class="text-sm text-white/80 mt-1">
                                Select inventory items then create an inspection record.
                            </p>
                        </div>
                ...
                <div class="bg-white">
                    <!-- HEADER + TOOLBAR -->
                    <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5 px-6 py-5 border-b border-gray-200">
                        <!-- LEFT FILTERS -->
